...
<body>
  ...
  <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="taxi_main">
                ...
                <p class="reader_text">Llega a cualquier destino de forma segura </p>
            ...
            <div class="col-sm-4">
              <div class="taxi_main">
                ...
                <p class="reader_text">Lllega de la manera mas rapida</p>
            ...
            <div class="col-sm-4">
              <div class="taxi_main">
                ...
                <p class="reader_text">Acceso a cualquier plaza </p>
                <div class="images_2"><img src="images/img-2.png"></a></div>
              </div>
            </div>
          </div>
    ...
    <div id="booking" class="ride_section layout_padding">
      <div class="container">
        <div class="ride_main">
          <h1 class="ride_text">¿Por qué <span style="color: #f4db31;">FASTY?</span></h1>
      </div>
        </div>
    </div>
      ...
      <div class="container-fluid">
        <div class="location_main">
          <div class="row">
            ...
            <div class="col-sm-5">
              <div class="download_text">DESCARGA<br><span style="color: #fffcf4;">NUESTRA APP</span></div>
            </div>
            <div class="col-sm-3">
          ...
          <div class="footer_section_2">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3">
                  <h2 class="account_text">Ubicación</h2>
                  <p class="ipsum_text">Estamos ubicados en todos los limites de los municipios en los que contamos con rutas.</p>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3">
                  <h2 class="account_text">Links</h2>
                  <div class="image-icon"><img src="images/bulit-icon.png"><span class="fb_text"><a href="#">Reserva

                  </span></a></div>
                <div class="image-icon"><img src="images/bulit-icon.png"><span class="fb_text"><a href="#booking">Acerca</span></a></div>
                <div class="image-icon"><img src="images/bulit-icon.png"><span class="fb_text"><a href="#taxi">Taxi</span></a></div>
                <div class="image-icon"><img src="images/bulit-icon.png"><span class="fb_text"><a href="#contact">Contacto</span></a></div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3">
                <h2 class="account_text">Siguenos</h2>
                <div class="image-icon"><img src="images/fb-icon.png"><span class="fb_text"><a href="#https://www.facebook.com/">Facebook</a></span></div>
                <div class="image-icon"><img src="images/twitter-icon.png"><span class="fb_text"><a href="#https://twitter.com/?lang=es">Twitter</a></span></div>           
                <div class="image-icon"><img src="images/instagram-icon.png"><span class="fb_text"><a href="#https://www.instagram.com/">Instagram</a></span></div>
                </div>
          </div>
          </div>
          </div>
